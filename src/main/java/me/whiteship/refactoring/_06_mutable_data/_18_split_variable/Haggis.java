...
public class Haggis {
    ...
    public double distanceTravelled(int time) {
        ...
        result = 0.5 * primaryAcceleration * primaryTime * primaryTime;     //the distance traveled by the initial thrust
        ...
        if (secondaryTime > 0) {
            ...
            result += primaryVelocity * secondaryTime + 0.5 * secondaryAcceleration * secondaryTime + secondaryTime; //the distance traveled by the second thrust
        }
